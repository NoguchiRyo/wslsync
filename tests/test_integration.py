...
class TestWSLSyncIntegration(unittest.TestCase):
    ...
    def test_complete_sync_workflow(self):
        ...
        for file_path in files_to_sync:
            ...
            self.assertEqual(source_content, dest_content, f"Content mismatch for {file_path}")
        ...
        for file_path in cleanup_files:
            ...
            self.assertFalse(cleanup_file.exists(), f"File {file_path} should be cleaned up")
        ...
        self.assertEqual(remaining_files, expected_files, "Only synced files should remain")
    ...
    def test_sync_with_modified_files(self):
        ...
        dest_content = dest_file.read_text()
        self.assertEqual(source_content, dest_content, "Modified file should be overwritten")
