...
from wslsync.config import WSLSyncConfig, parse_config, validate_config, get_default_config_path
...
files = ["file1.txt"]"""
    ...
    def test_parse_valid_config_file(self):
        ...
        with tempfile.NamedTemporaryFile(mode='w', suffix='.wslsync', delete=False) as f:
