...
from wslsync.__main__ import (
    create_argument_parser, main, run_sync, 
    validate_config_command, show_version
)
...
""")
    ...
    def test_run_sync_success(self, mock_setup_logging, mock_parse_config, mock_engine_class):
    ...
    @patch('wslsync.__main__.parse_config')
    @patch('wslsync.__main__.setup_logging')
    def test_run_sync_dry_run_mode(self, mock_setup_logging, mock_parse_config, mock_engine_class):
        ...
        mock_engine = MagicMock()
        mock_engine.get_source_files.return_value = [Path("file1.txt"), Path("file2.txt")]
    ...
    @patch('wslsync.__main__.parse_config')
    @patch('wslsync.__main__.setup_logging')
    def test_run_sync_engine_exception(self, mock_setup_logging, mock_parse_config, mock_engine_class):
...
""")
    ...
    @patch('wslsync.__main__.parse_config')
    def test_validate_config_command_valid(self, mock_parse_config, mock_validate_config):
    ...
    @patch('wslsync.__main__.validate_config')
    @patch('wslsync.__main__.parse_config')
    def test_validate_config_command_invalid(self, mock_parse_config, mock_validate_config):
